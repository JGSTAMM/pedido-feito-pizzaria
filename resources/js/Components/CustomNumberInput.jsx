    ...
    return (
        <div className={`flex items-center bg-surface border border-border-subtle rounded-xl overflow-hidden h-11 shadow-lg transition-all focus-within:border-primary/40 focus-within:ring-1 focus-within:ring-primary/20 ${className}`}>
            <button
                ...
                className="w-10 shrink-0 h-full flex items-center justify-center hover:bg-white/5 active:bg-white/10 text-gray-400 hover:text-white transition-all disabled:opacity-20 disabled:cursor-not-allowed border-r border-border-subtle"
            >
            ...
            <div className="flex-1 min-w-0 flex items-center px-2">
                {prefix && <span className="text-text-muted text-sm font-bold mr-1 select-none">{prefix}</span>}
                <input
                    {...props}
                    ref={ref}
                    type="number"
                    ...
                    onBlur={handleBlur}
                    step={step}
                    className="flex-1 w-full min-w-0 bg-transparent border-none text-left text-sm font-bold text-white focus:ring-0 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none p-0"
                />
            </div>
            ...
            <button
                ...
                className="w-10 shrink-0 h-full flex items-center justify-center hover:bg-white/5 active:bg-white/10 text-gray-400 hover:text-white transition-all disabled:opacity-20 disabled:cursor-not-allowed border-l border-border-subtle"
            >
