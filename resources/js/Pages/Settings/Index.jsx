...
function TabPerfil({ settings }) {
    ...
    const handleCNPJChange = (e) => {
        ...
        profileForm.setData('cnpj', maskedValue);
    };
                ...
                <form onSubmit={saveProfile} className="space-y-6">
                    <div className="grid grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" value={profileForm.data.cnpj} onChange={handleCNPJChange} placeholder="00.000.000/0000-00" className="w-full bg-background-dark border border-border-subtle rounded-xl px-4 py-3 text-white focus:outline-none focus:border-primary/50 transition-all" />
                        </div>
                        <div>
