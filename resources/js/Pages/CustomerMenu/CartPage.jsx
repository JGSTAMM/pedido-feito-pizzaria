        ...
        <main className="min-h-screen bg-[#0D0D12] text-white pb-32">
            ...
            <header className={`${luccheseMenuTheme.glass} sticky top-0 z-30 flex items-center justify-between px-6 py-4 border-b border-white/5`}>
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-xl font-black italic tracking-tight">Seu Carrinho</h1>
                        {identity && (
            ...
            <div className="mx-auto max-w-lg px-4 py-8">
                {items.length === 0 ? (
                    <div className="flex flex-col items-center justify-center py-20 text-center animate-in fade-in slide-in-from-bottom-4 duration-500">
                        ...
                        <h2 className="text-2xl font-black italic tracking-tight mb-2">Carrinho Vazio</h2>
                        <p className="text-sm font-semibold text-text-muted max-w-[250px]">
                            Você ainda não adicionou nenhum item. Que tal explorar nosso cardápio?
                        </p>
                        <Link
                            href="/menu"
                    ...
                    <div className="space-y-6">
                        ...
                        <div className={`${luccheseMenuTheme.glass} rounded-3xl p-6 mt-8 space-y-4`}>
                            <h3 className="text-[11px] font-black uppercase tracking-[0.2em] text-primary italic mb-4">Resumo do Pedido</h3>
                            ...
                            <div className="flex items-center justify-between text-sm font-bold text-text-muted">
                                ...
                                <span className="text-[10px] uppercase tracking-widest text-[#06b6d4]">A Calcular</span>
                            </div>
